...
public class Quiz {
		...
		boolean answer35 =false; //because (') is used in sequence? True w/o (')?
		...
		boolean answer39 =false; // because (') is used in sequence? True w/o (')?
		 ...
		 *  which has a minimum value of -231 and a maximum value of 231-1. In Java SE 8 and 
		 *  later, you can use the int data type to represent an unsigned 32-bit integer, 
		 *  which has a minimum value of 0 and a maximum value of 232-1. Use the Integer class 
		 *  to use int data type as an unsigned integer. See the section The Number Classes 
		 *  for more information. Static methods like compareUnsigned, divideUnsigned etc have 
		 *  been added to the Integer class to support the arithmetic operations for unsigned 
		 *  integers.
		
		 *  long: The long data type is a 64-bit two's complement integer. The signed long has 
		 *  a minimum value of -263 and a maximum value of 263-1. In Java SE 8 and later, you 
		 *  can use the long data type to represent an unsigned 64-bit long, which has a minimum 
		 *  value of 0 and a maximum value of 264-1. Use this data type when you need a range 
		 *  of values wider than those provided by int. The Long class also contains methods 
		 *  like compareUnsigned, divideUnsigned etc to support arithmetic operations for 
		 *  unsigned long.
		...
		/* 44. Write a method named multiplyName that takes two parameters, a String name and an int times.
